...
func runtimeWebsocketStatus() runtimeWebsocketResponse {
	return runtimeWebsocketResponseFromSnapshot(wsrelay.GetManager().SafePoolRuntimeSnapshot())
}

func runtimeWebsocketResponseFromSnapshot(snapshot wsrelay.SafePoolRuntime) runtimeWebsocketResponse {
	...
	return runtimeWebsocketResponse{
		...
		OwnerSampleBPS:              snapshot.OwnerSampleBPS,
		OwnerBudgetPerAccount:       snapshot.OwnerBudgetPerAccount,
		OwnerAdmissionConfigValid:   snapshot.OwnerAdmissionConfigValid,
		OwnerAdmissionSaltReady:     snapshot.OwnerAdmissionSaltReady,
		AdmittedOwners:              snapshot.AdmittedOwners,
		AdmittedOwnerAccounts:       snapshot.AdmittedOwnerAccounts,
		OwnerBudgetOvercommitted:    snapshot.OwnerBudgetOvercommitted,
		ContinuationGlobalLimit:     snapshot.ContinuationGlobalLimit,
		ContinuationPerAccountLimit: snapshot.ContinuationPerAccountLimit,
		...
		OwnerAdmittedNew:            metrics.OwnerAdmittedNew,
		OwnerAdmittedExisting:       metrics.OwnerAdmittedExisting,
		OwnerSampleRejected:         metrics.OwnerSampleRejected,
