...
type runtimeWebsocketResponse struct {
	...
	OwnerSampleBPS              int    `json:"owner_sample_bps"`
	OwnerBudgetPerAccount       int    `json:"owner_budget_per_account"`
	OwnerAdmissionConfigValid   bool   `json:"owner_admission_config_valid"`
	OwnerAdmissionSaltReady     bool   `json:"owner_admission_salt_ready"`
	AdmittedOwners              int    `json:"admitted_owners"`
	AdmittedOwnerAccounts       int    `json:"admitted_owner_accounts"`
	OwnerBudgetOvercommitted    int    `json:"owner_budget_overcommitted_accounts"`
	ContinuationGlobalLimit     int    `json:"continuation_global_limit"`
	ContinuationPerAccountLimit int    `json:"continuation_per_account_limit"`
	...
	OwnerAdmittedNew            uint64 `json:"owner_admitted_new"`
	OwnerAdmittedExisting       uint64 `json:"owner_admitted_existing"`
	OwnerSampleRejected         uint64 `json:"owner_sample_rejected"`
