...
import { LayoutDashboard, Users, Activity, Settings, Server, Languages, Globe, BookOpen, KeyRound, Image as ImageIcon, ShieldAlert, ExternalLink, ChevronLeft, Palette, Sun, Moon, LogOut, Download, Loader2, RefreshCw, Menu, X, CircleDollarSign, Braces, ClipboardList } from 'lucide-react'
...
const navDefs: NavDef[] = [
  ...
  { to: '/codex-audit', labelKey: 'nav.codexAudit', icon: <ClipboardList className="size-[18px]" /> },
